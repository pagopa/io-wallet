...
export const HARDWARE_PUBLIC_TEST_JWK =
  "";
...
export const AttestationServiceConfiguration = t.type({
  ...
  hardwarePublicTestJwk: t.string,
...
> = pipe(
  sequenceS(RE.Apply)({
    ...
    hardwarePublicTestJwk: pipe(
      readFromEnvironment("HardwarePublicTestJwk"),
      RE.orElse(() => RE.right(HARDWARE_PUBLIC_TEST_JWK)),
      RE.map(decodeBase64String),
    ),
