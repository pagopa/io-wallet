...
| <a name="input_pid_issuer_revoke_api_queue_name"></a> [pid\_issuer\_revoke\_api\_queue\_name](#input\_pid\_issuer\_revoke\_api\_queue\_name) | Pid Issuer Revoke API Queue Name | `string` | n/a | yes |
