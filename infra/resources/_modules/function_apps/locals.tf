locals {
  ...
  function_app_user_common_app_settings = merge(
    ...
    local.function_app_user_envs_shared_app_settings,
    {
      ...
      FederationEntityKeyId                                 = "FEDERATION_ENTITY_KEY_ID"
      TokenStatusListKeyId                                  = "TOKEN_STATUS_LIST_KEY_ID"
      WalletAttestationKeyId                                = "WALLET_ATTESTATION_KEY_ID"
      WalletInstanceAttestationKeyId                        = "WALLET_INSTANCE_ATTESTATION_KEY_ID"
      WalletUnitAttestationKeyId                            = "WALLET_UNIT_ATTESTATION_KEY_ID"
  ...
  function_app_user_uat_common_app_settings = merge(
    local.function_app_user_envs_shared_app_settings,
    {
      ...
      StatusListBaseUrl = format(
        ...
        var.status_list_storage_container_name_uat,
      )
      StatusListStorageAccountName                          = var.status_list_storage_account_name_uat
      ...
      FederationEntityKeyId                                 = "FEDERATION_ENTITY_KEY_ID_UAT"
      TokenStatusListKeyId                                  = "TOKEN_STATUS_LIST_KEY_ID_UAT"
      WalletAttestationKeyId                                = "WALLET_ATTESTATION_KEY_ID_UAT"
      WalletInstanceAttestationKeyId                        = "WALLET_INSTANCE_ATTESTATION_KEY_ID_UAT"
      WalletUnitAttestationKeyId                            = "WALLET_UNIT_ATTESTATION_KEY_ID_UAT"
  ...
  function_app_user_uat = {
    app_settings = merge(
      local.function_app_user_uat_common_app_settings,
      {
        for to_disable in local.function_app_user_slot_disabled :
        format("AzureWebJobs.%s.Disabled", to_disable) => 0
      },
      {
        for to_disable in local.function_app_user_uat_both_slots_disabled :
        format("AzureWebJobs.%s.Disabled", to_disable) => 1
      }
    )
