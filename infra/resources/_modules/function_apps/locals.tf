locals {
  ...
  function_app_user_common_app_settings = merge(
    ...
    local.function_app_user_envs_shared_app_settings,
    {
      ...
      TokenStatusListKeyId                                  = "Q1yVyGZQ9hFE2MEcsZN_r-2WccrhKPgirpZR-pCkoM0"
      WalletAttestationKeyId                                = "Q1yVyGZQ9hFE2MEcsZN_r-2WccrhKPgirpZR-pCkoM0"
      WalletInstanceAttestationKeyId                        = "Q1yVyGZQ9hFE2MEcsZN_r-2WccrhKPgirpZR-pCkoM0"
      WalletUnitAttestationKeyId                            = "Q1yVyGZQ9hFE2MEcsZN_r-2WccrhKPgirpZR-pCkoM0"
  ...
  function_app_user_uat_common_app_settings = merge(
    local.function_app_user_envs_shared_app_settings,
    {
      ...
      WalletUnitAttestationKeyId                            = "8UkfrvttLkpAQOOp4KYpaPsBLlvb2hhAAyTLBVN6NUc"
