...
module "function_apps" {
  ...
  send_email_queue_name                            = module.storage_accounts.revocation_queue_name_02.name
  validate_wallet_instance_certificates_queue_name = module.storage_accounts.revocation_queue_name_02q.name
