...
module "function_apps" {
  ...
  send_email_queue_name                            = module.storage_accounts.wallet_instances_creation_check_01.name
  validate_wallet_instance_certificates_queue_name = module.storage_accounts.wallet_instances_creation_check_01.name
