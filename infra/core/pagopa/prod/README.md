...
This directory contains the Terraform configuration used to create the Private Endpoint in the IO virtual network that exposes the PSN Application Gateway to IO VNet.
