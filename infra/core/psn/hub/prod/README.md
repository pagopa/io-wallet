...
This directory contains the Terraform code to deploy changes to PSN Hub infrastructure. Most of the resources have been deployed by PSN itself on behalf of IT-Wallet project and then imported here, so it was not possible to adhere to PagoPA naming conventions.
